...
public class EqualityComparer<T> : IEqualityComparer<T>
{
    ...
    private static Func<T, T, bool> GetEqualityFunction()
    {
        ...
        var allPropertiesEqualExpression = Properties.Select(propertyInfo => Expression.Equal(Expression.Property(prm1, propertyInfo), Expression.Property(prm2, propertyInfo))).Aggregate(Expression.AndAlso);
